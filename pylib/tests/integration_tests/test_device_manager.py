...
class DeviceManagerTest(unittest.TestCase):
    ...
    def test_device_keyboard_effect_wheel(self):
        ...
        device.fx.wheel(openrazer.client.constants.WAVE_LEFT)
        self.assertEqual(self._bw_chroma.get('matrix_effect_wheel'), str(openrazer.client.constants.WAVE_LEFT))
        device.fx.wheel(openrazer.client.constants.WAVE_RIGHT)
        self.assertEqual(self._bw_chroma.get('matrix_effect_wheel'), str(openrazer.client.constants.WAVE_RIGHT))
